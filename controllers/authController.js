  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <p>Hi ${to.split('@')[0]},</p>
        <p>Your one-time password for <b>ChatHub ${type}</b> is <b>${otp.toString()}</b> valid for the next 2 minutes. For safety reasons, <b>PLEASE DO NOT SHARE YOUR OTP</b> with anyone. </p>
        <div style="margin: 0 auto; background-color: #f0f0f0; padding: 10px; border-radius: 5px; margin-top: 20px; text-align: center; width: 150px;">
          ...
          <a href = ${
            process.env.CHATHUB_SITE
          } style="display: inline-block; padding: 10px 20px; background-color: #6a73fa; color: #fff; text-decoration: none; border-radius: 5px;">Go to ChatHub</a>       
        </div>
         <p style="margin-top: 20px;">Best Regards,<br><b>ChatHub</b></p>
        <div style="margin-top: 20px; background-color: #f0f0f0; padding: 10px; border-radius: 5px; text-align: center;">
            <p style="margin: 0;">&copy; Copyright ChatHub</p>
          </div>
      </div>
       `,
    };
