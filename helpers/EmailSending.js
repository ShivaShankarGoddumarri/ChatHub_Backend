  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
            ...
            <p>Hi, <b>${userName}</b></p>
            <p>${body}</p>
              <a href = ${process.env.CHATHUB_SITE} style="display: inline-block; padding: 10px 20px; background-color: #6a73fa; color: #fff; text-decoration: none; border-radius: 5px;">Go to ChatHub</a>       
